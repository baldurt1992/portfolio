  ...
  <div
    ...
    <div class="pointer-events-auto mx-auto max-w-md">
      <NuxtLink :to="contactTo"
        class="flex items-center justify-center gap-2 rounded-xl bg-accent px-4 py-3 text-base font-semibold text-slate-900 shadow-lg transition-all hover:bg-accent-hover hover:-translate-y-0.5"
